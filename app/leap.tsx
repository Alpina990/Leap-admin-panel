...
export default function Home({session}:{session:AdminSession}){
 ...
 const values:Record<string,string>={
  ...
  'Learning Pulse Title':'Learning activity unavailable',
  'Learning Pulse Description':'Completion and presence data are not provided.',
  'Learners Subtitle':'Identity from the read-only directory. Access and progress are unavailable.',
  ...
  'Learner Attention Rule Copy':'Internal notes are private and audited. Access corrections are not connected.',
